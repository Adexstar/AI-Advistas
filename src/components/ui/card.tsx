...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "w-full min-w-0 overflow-hidden rounded-xl border bg-card text-card-foreground shadow-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "break-words text-2xl font-semibold leading-tight tracking-tight",
      className
    )}
    {...props}
  />
