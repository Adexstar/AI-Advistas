...
const AdPreviewSimulator = ({ adContent, isGenerating = false }: AdPreviewSimulatorProps) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
      ...
      {/* Right Panel - Metrics and Preview */}
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="text-xs">
                {selectedPlatform.charAt(0).toUpperCase() + selectedPlatform.slice(1)} • {deviceView}
              </Badge>
            </CardTitle>
          </CardHeader>
          <CardContent className="flex-1">
            <div className="h-full min-h-[500px] flex items-center justify-center">
              <div className={deviceView === "mobile" ? "max-w-sm mx-auto" : "max-w-2xl mx-auto w-full"}>
                <SocialMediaPreview 
                  formData={{
                    ...formData,
